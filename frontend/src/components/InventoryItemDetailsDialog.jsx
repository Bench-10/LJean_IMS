...
function InventoryItemDetailsDialog({ open, onClose, user, item }) {
  ...
  // still guard against missing item
  if (!item) return null;
            ...
            <div className="pt-2 px-2 lg:px-8 w-full flex-1 flex flex-col">
              <div className="mb-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div
                    className={`border rounded-full px-4 py-1 mr-3 lg:mr-0 text-sm font-medium ${statusClass}`}
                  >
                    {status}
                  </div>
                </div>
                <p className="text-xs text-gray-500">
                  Review the current details of this inventory item.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <div className="p-2 bg-gray-50 border rounded-lg text-sm">
                    {item.product_id}
                  </div>
                </div>
                <div>
