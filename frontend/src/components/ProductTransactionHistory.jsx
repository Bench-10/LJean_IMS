  ...
  return (
    <div>
      ...
      >
        {/* MODAL SHELL */}
        <div
          className="relative mx-auto my-4 sm:my-10 w-[100vw] sm:w-[95vw] max-w-[1200px]
                     max-h-[90vh] bg-white border border-gray-600/40 rounded-xl
                     p-3 sm:p-4 lg:p-7 pb-6 sm:pb-8 flex flex-col overflow-hidden shadow-lg"
        >
          <button
            type="button"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center w-full sm:w-auto gap-2 sm:gap-3">
                ...
                <div className="relative mt-2 sm:mt-0 w-full lg:w-auto overflow-visible">
                  {openFilter && (
                    ...
                    >
                      <div
                        className="w-[92vw] sm:w-[360px] max-w-[420px]
                  ...
                  <button
                    className={`h-9 w-full sm:w-9 flex items-center justify-center border border-gray-300 rounded-md 
                                ...
                                ${
                                  openFilter
                                    ? 'ring-2 ring-blue-500 border-blue-500 bg-gray-50'
                                    : 'focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                                }`}
                    onClick={() => {
                      openFilter ? closeFilterValue() : setOpenFilter(true);
                    }}
                  >
          ...
          <div className="w-full flex-1 mt-4 rounded-lg shadow-sm border border-gray-200 bg-white flex flex-col overflow-hidden">
              ...
              <table className="w-full table-fixed xl:min-w-[1100px]">
                <thead className="sticky top-0 h-10 z-40">
                  <tr className="bg-gray-200">
                    <th className="w-[16%] px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                      Date
                    </th>
                    <th className="w-[26%] px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                      Item Name
                    </th>
                    <th className="w-[26%] px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                      Category
                    </th>
                    <th className="w-[10%] px-4 lg:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                      Unit Cost
                    </th>
                    <th className="w-[8%] px-4 lg:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                      Quantity
                    </th>
                    <th className="w-[14%] px-4 lg:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                      Value
                    </th>
                  </tr>
                </thead>
                    ...
                    currentData.map((history, histoindx) => {
                      ...
                      return (
                        <tr
                          ...
                          className={`transition-colors duration-300 ease-in-out border-b border-gray-100 ${
                            isHighlighted ? 'bg-green-200' : 'hover:bg-gray-100'
                          }`}
                        >
                          {/* DATE */}
                          <td className="w-[16%] px-4 lg:px-6 py-3 whitespace-nowrap text-xs sm:text-sm text-gray-500">
                            {history.formated_date_added}
                          </td>

                          {/* ITEM NAME – wraps instead of overlapping */}
                          <td className="w-[26%] px-4 lg:px-6 py-3 text-xs sm:text-sm font-medium text-gray-900 align-middle whitespace-normal break-words">
                            {history.product_name}
                          </td>

                          {/* CATEGORY – wraps instead of overlapping */}
                          <td className="w-[26%] px-4 lg:px-6 py-3 text-xs sm:text-sm text-gray-500 align-middle whitespace-normal break-words">
                            {history.category_name}
                          </td>

                          {/* UNIT COST */}
                          <td className="w-[10%] px-4 lg:px-6 py-3 whitespace-nowrap text-xs sm:text-sm text-gray-900 text-right">
                          ...
                          {/* VALUE */}
                          <td className="w-[14%] px-4 lg:px-6 py-3 whitespace-nowrap text-xs sm:text-sm text-gray-900 text-right">
            ...
            {/* Mobile cards */}
            <div className="sm:hidden h-full overflow-y-auto divide-y divide-gray-100 pt-2 pb-4">
              {loading ? (
                <div className="py-6">
                  <ChartLoading message="Loading product history..." />
                </div>
                  ...
                  return (
                    <div
                      ...
                      className={`px-3 py-3 text-xs ${
                        isHighlighted ? 'bg-green-100' : 'bg-white'
                      }`}
                    >
            ...
            <div className="flex flex-col sm:hidden gap-2">
              ...
              <div className="flex justify-center">
                <div className="relative group w-full max-w-xs">
                  ...
                  {/* Drops up on mobile */}
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-1 bg-white border border-gray-300 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20 w-full">
                    <button
