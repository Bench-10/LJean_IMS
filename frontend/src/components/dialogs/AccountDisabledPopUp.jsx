  ...
  const getContent = () => {
    if (isDeleted) {
      ...
      return {
        ...
        message: !user ? "Your account is currently disabled due to many failed login attempts." : "Your account has been disabled by the administrator. You have no access to your account this moment.",
        buttonText: "Logout",
        bgColor: "bg-red-100"
      };
    }
